...
ref = Array.new
#str1d  =  ".._\\||\\///.../.........\\..|..0...0...|.|....\\/....|..\\..\\___/../...\\......./.....|......|.."
ref = lire_text_art("text_art_0.txt")
symboles = ref.uniq
...
#individus.each {|ind| afficher_chromosome_1d(ind.chromosome)}
#puts
#individus.each {|ind| afficher_chromosome_2d(ind.chromosome, colonnes, rangees); puts}
#exit
...
if false
individus.each_with_index  do |ind, i|
  puts "Individu #{i}  Score : #{ind.score}"
  afficher_chromosome_1d(ind.chromosome)
  afficher_chromosome_2d(ind.chromosome, colonnes, rangees)
  puts
end
exit
end
